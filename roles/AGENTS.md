...
- **`triangulate_mesh`** — agent-authored role (created via the declarative-direct face). The TRIANGULATION seat of the mesh swarm (2026-07-07): reads the round's N territory-observations (from observe_territory lenses) PLUS the p
