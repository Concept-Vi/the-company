"""roles/sentimentprobe.py — operator-authored cognition role (Concurrent Cognition C7.4/C7.5).
...
class SentimentprobeOut(BaseModel):
    tone: str = ''
    strong: bool = False
...
ROLE = {
    ...
    "output_schema": SentimentprobeOut,
}
