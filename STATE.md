...
- **Voice (`listening` mode)** — NOT built. It's the agreed next item (local Whisper + local TTS, a separate service-venv); the live mic→speaker loop needs the operator to confirm.
