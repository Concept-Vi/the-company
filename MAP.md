...
- **node-types** (17): ask, codebase, constant, embed, gate, join, llm, model_of_tim, pair, portal, retrieve, reverse, rhm_mode, similarity, titlecase, uppercase, wordcount
