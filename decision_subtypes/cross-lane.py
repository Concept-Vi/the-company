"""decision_subtypes/cross-lane.py — a fabric TECHNICAL choice the streams settle (not Tim's eye).
Derived from the gather: C4 translator-storage, C5 island-schema-removal, C6 archetype-dispatch, F4 mind-row,
F5 vLLM-think, F6 prompt-template, D3 session-card-shape, R-corpus-1 version-control. The fabric-call kind."""
...
DECISION_SUBTYPE = {
    ...
    "desc": "A cross-lane technical choice the streams settle — the options + the LANE-IMPACT (who it affects) + "
            ...
            "storage · island-schema-removal · archetype-dispatch · the fork follows · session-card-shape.",
}
