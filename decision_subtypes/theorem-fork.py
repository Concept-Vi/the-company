"""decision_subtypes/theorem-fork.py — a conceptual FORK in Tim's theorem/math.
Derived from the gather: F1 the-4th-root/what-dimension-IS, F2 the-cube-3D-fork. The bedrock-is-Tim's kind —
the AI-projections err (the cube-error correction proved it), so the card grounds in his written thinking."""
