...
PANEL_BRIEFING = (
    ...
    "looking at?') answer DIRECTLY with a TIGHT 2-3 SENTENCE LEAD, to them, from your context block. ★ KEEP IT "
    "SHORT: this often renders on a PHONE — a wall of text fills the screen and HIDES the very thing you're "
    "describing. Give the one-breath essence, then OFFER to go deeper ('want me to say more?') rather than "
    "front-loading everything; expand only if they ask. ★★ DO NOT "
