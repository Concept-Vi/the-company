...
print(f"\n{'PASS' if FAIL == 0 else 'FAIL'} — {PASS} passed, {FAIL} failed "
      f"(Group 6 semantic radius: origin-centred, monotone, full-radius, centre-outlier excluded, "
      f"vectorless→rim+flag, fail-loud, additive. Live path verified by use.)")
