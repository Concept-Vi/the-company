...
_Ops parsed: 78. Machine-regenerated by `tools/coverage.py --render-md` from the live join (resources/*.md `atlas:`+`status:` ↔ atlas/FEATURE-ATLAS.md). This block is the only machine-owned region; all prose below is human-authored and preserved._
